...
Thickness and indenter radius are expected in matching length units. The examples use millimeters.

## Protocol assumptions

The current high-level functions are centered on three-step stress-relaxation workflows. Some lower-level helper functions also support an optional fourth step.
