...
#'
#' Extract parameters for calculation of the moduli from extracted Stress-Relaxation data (3-4 steps), compared to the 1st version a 
#' new option added to adjust the data points to be considered, and allow adding a 4th step
#'
...
#' @param EqDataPoints the number of data points to be included in the measurements of the equilibrium modulus, add 1 to the desired
#' values (default is 201)
#' @return a list of the equilibrium forces (Se1, Se2, Se3, and optionally Se4), the peak forces (Sp1, Sp2, Sp3, and optionally Sp4),
#' and the forces just before the peaks (Sm1, Sm2, Sm3, and optionally Sm4) of the three/four steps, respectively.
#' @export
