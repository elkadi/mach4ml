...
`mach4ml` is an R package for extracting, cleaning, organizing, and analyzing Biomomentum MACH-1 text exports, with a focus on stress-relaxation experiments and high-throughput workflows that produce large data sets for downstream analysis or machine-learning pipelines. The current documantation is generated by ChatGPT, and not revised yet.
...
This repository currently uses the pre-release/development R package version `0.1.0.9000`
